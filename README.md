...
- **Security**
  - [JWT & OAuth0 This is an external link to genome.gov](https://github.com/manueldvr/MyDocuments/blob/master/security/JWT%20y%20Auth0.md)
  - [XSS, SQL injection, JPA, Bean Validation](https://github.com/manueldvr/MyDocuments/blob/master/security/security_0.md)
- **OO, programación**
  - **OO**
...
- **Persistencia**
    - [Navegacion en BD con JPA- sintesis](https://github.com/manueldvr/MyDocuments/blob/master/spring/Navegacion.md)
    - [JPA]()
